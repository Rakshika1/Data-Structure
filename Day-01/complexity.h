...
void* operator new(size_t size) {
    ...
    if (_tracking && size >= 16) {  // sirf 16+ bytes track karo
...
struct AutoStart {
    ...
    ~AutoStart() {
        ...
        cout << "\nTime Complexity   : ";
        if      (_stepCount <= 5)   cout << "O(1)   - Constant    BEST  +++" << endl;
        else if (_stepCount <= 15)  cout << "O(logn)- Logarithmic GOOD  ++"  << endl;
        else if (_stepCount <= 100) cout << "O(n)   - Linear      OK    +"   << endl;
        else                        cout << "O(n^2) - Quadratic   SLOW  -"   << endl;
        ...
        cout << "\nSpace Complexity  : ";
        if      (_totalBytes <= 32)       cout << "O(1)   - Constant BEST +++" << endl;
        else if (_totalBytes <= 256)      cout << "O(logn)- Low      GOOD ++"  << endl;
        else if (_totalBytes <= 1024 * 5) cout << "O(n)   - Linear   OK   +"   << endl;
        else                              cout << "O(n^2) - High     BAD  -"    << endl;
